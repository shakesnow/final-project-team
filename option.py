...
# Data specifications
parser.add_argument('--dir_train', type=str, default='dataset/train_data_merge/',
                    help='training dataset directory')
parser.add_argument('--dir_val', type=str, default='dataset/val_data/',
                    help='validation dataset directory')
parser.add_argument('--dir_test', type=str, default='dataset/test_data_merge/',
...
parser.add_argument('--save_dir', type=str, default='results_merge',
                    help='test results_generate directory')
...
parser.add_argument('--eval', action='store_true',
                    help='evaluate the test results_generate')
