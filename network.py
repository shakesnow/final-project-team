...
class CNNAE3D512(chainer.Chain):
    ...
    def __init__(self, train=True):
        ...
        super(CNNAE3D512, self).__init__(
            c0=L.Convolution2D(3, 32, 4, stride=2, pad=1, initialW=w),
            c1=L.Convolution2D(32, 64, 4, stride=2, pad=1, initialW=w),
            c2=L.Convolution2D(64, 128, 4, stride=2, pad=1, initialW=w),
            c3=L.Convolution2D(128, 256, 4, stride=2, pad=1, initialW=w),
            c4=L.Convolution2D(256, 256, 4, stride=2, pad=1, initialW=w),
            c5=L.Convolution2D(256, 256, 4, stride=2, pad=1, initialW=w),
            c6=L.Convolution2D(256, 256, 4, stride=2, pad=1, initialW=w),
            c7=L.Convolution2D(256, 256, 4, stride=2, pad=1, initialW=w),
            c8=L.Convolution2D(256, 256, 4, stride=2, pad=1, initialW=w),

            dc00=L.DeconvolutionND(3, 256, 256, (4, 4, 4), stride=(2, 2, 2), pad=1, initialW=w),
            dc0=L.DeconvolutionND(3, 512, 256, (4, 4, 4), stride=(2, 2, 2), pad=1, initialW=w),
            dc1=L.DeconvolutionND(3, 512, 256, (4, 4, 4), stride=(2, 2, 2), pad=1, initialW=w),
            dc2=L.DeconvolutionND(3, 512, 256, (3, 4, 4), stride=(1, 2, 2), pad=1, initialW=w),
            dc3=L.DeconvolutionND(3, 512, 256, (3, 4, 4), stride=(1, 2, 2), pad=1, initialW=w),
            dc4=L.DeconvolutionND(3, 512, 128, (3, 4, 4), stride=(1, 2, 2), pad=1, initialW=w),
            dc5=L.DeconvolutionND(3, 256, 64, (3, 4, 4), stride=(1, 2, 2), pad=1, initialW=w),
            dc6=L.DeconvolutionND(3, 128, 32, (3, 4, 4), stride=(1, 2, 2), pad=1, initialW=w),
            dc7=L.DeconvolutionND(3, 64, 3, (3, 4, 4), stride=(1, 2, 2), pad=1, initialW=w),
            ...
            bnc8=L.BatchNormalization(256),

            bndc00=L.BatchNormalization(256),
            bndc0=L.BatchNormalization(256),
            bndc1=L.BatchNormalization(256),
            bndc2=L.BatchNormalization(256),
            bndc3=L.BatchNormalization(256),
            bndc4=L.BatchNormalization(128),
            bndc5=L.BatchNormalization(64),
            bndc6=L.BatchNormalization(32)
        )
        self.train = train
